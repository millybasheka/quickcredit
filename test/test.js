...
describe('All Routes', () => {
  ...
  it('1 should post a loan repayment successfully (ADMIN)', (done) => {
    chai.request(app)
  ...
  it('3 should post a loan repayment successfully (ADMIN)', (done) => {
    chai.request(app)
      .post('/api/v1/loans/repayments')
      .set('Authorization', adminToken)
      .send({ amount: 900, email: 'elemanhillary@gmail.com' })
  ...
  it('4 should post a loan repayment successfully (ADMIN)', (done) => {
    chai.request(app)
      .post('/api/v1/loans/repayments')
      .set('Authorization', adminToken)
      .send({ amount: 900, email: 'elemanhillary@gmail.com' })
